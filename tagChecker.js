module.exports.tagChecker = function (paragraph) {
  ...
  while (i <= paragraph.length - 3) {
    ...
    if (patternOpenTag.test(next3Letter)) {
      ...
      i = i + 3; //Go to the next char after this opening tag
      ...
      i = i + 4; //Go to the next char after this closing tag
    } else {
      i++;
    }
  }
  //Check if the stack is empty, if it is not, that means there are unmacthed opening tags.
